...
export default function CloudBackupSettings() {
  ...
  const handleVerifyNativePurchase = async (transaction: any) => {
    ...
    try {
      let packageName = 'com.inspirapos.app';
      try {
    ...
    <div className="px-4 pt-6 pb-20 space-y-4">
      ...
      {!isLoggedIn ? (
        <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-primary/15 via-primary/5 to-transparent p-6 text-center space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed max-w-[280px] mx-auto">
                  {t('cloudBackup.hero.description', { dashboard: 'dashboard.inspiralabs.id' })}
                </p>
              </div>
            ...
            <CardContent className="p-5 space-y-4">
              <ul className="space-y-3">
                ...
                <BenefitItem
                  ...
                  desc={t('cloudBackup.benefits.dashboard.desc', { dashboard: 'dashboard.inspiralabs.id' })}
                />
                <BenefitItem
          ...
          <a
            href="https://dashboard.inspiralabs.id"
            target="_blank"
            rel="noopener noreferrer"
            className="block text-center text-[11px] font-medium text-primary"
          >
            {t('cloudBackup.previewDashboard', { dashboard: 'dashboard.inspiralabs.id' })}
          </a>
        </div>
      ) : (
        <>
            ...
            {isSyncSubscribed && (
              <>
                <ExternalMenuCard
                  ...
                  subtitle={t('cloudBackup.menu.dashboard.subtitle', { dashboard: 'dashboard.inspiralabs.id' })}
                />
                <MenuCard
