...
export const FEATURES: WhatsNewFeature[] = [
  ...
  {
    id: '2026-06-rebrand-inspirapos',
    title: 'Wajah Baru: Inspira POS',
    description:
      'Aplikasi ini kini bernama Inspira POS dengan tampilan dan warna baru yang lebih segar. Fungsi & data kamu tetap sama, tidak ada yang berubah. Suka warna lain? Kamu tetap bisa pilih tema favoritmu di Pengaturan → Warna Tema.',
    icon: Sparkles,
    iconColor: 'text-primary bg-primary/10',
