...
// Create context to share open state with DialogContent for AnimatePresence
const DialogContext = React.createContext<{ open: boolean }>({ open: false });

const Dialog = ({ children, open: controlledOpen, defaultOpen, onOpenChange, ...props }: DialogPrimitive.DialogProps) => {
